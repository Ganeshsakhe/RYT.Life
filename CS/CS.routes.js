...
const csController = require('./CS controller');
...
const therapistModel = require('../therapist/therapist.model');


router.post('/login', csController.login);

router.post('/logout', csController.logout);
...
const csControllers = require('./CS.controller');

router.post('/appointment', csControllers.createAppointment)
